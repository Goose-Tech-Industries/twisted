  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {TePhoenixWeb.Layouts, :admin}

      on_mount {TePhoenixWeb.Admin.AdminHelpers, :load_pinned_notes}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: TePhoenixWeb.Router,
        statics: TePhoenixWeb.static_paths()
    end
  end
