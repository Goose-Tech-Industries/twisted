...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  // Settings use defaults each session — no localStorage.
  // TEACHING: Keybinds and UI scale reset on refresh. This is the safest
  // approach for deployment. Server-side persistence (via state_json or a
  // dedicated settings table) can be added later.
