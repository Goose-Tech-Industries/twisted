...
import { Shield, Sparkles, ListChecks, ToggleLeft, GitBranch, Crown, TrendingUp } from "lucide-react"
import { EntityManager } from "./entity-manager"
import { ClassSkillPanel } from "./class-skill-panel"

type ClassTab = "classes" | "subclasses" | "mastery" | "skills" | "skill_assign" | "race_access" | "levels"
...
const TABS: Array<{ id: ClassTab; label: string; icon: React.ElementType }> = [
  ...
  { id: "levels",       label: "Level Table",  icon: TrendingUp },
]
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {tab === "levels"       && <EntityManager section="level_req" />}
      </div>
    </div>
  )
}
