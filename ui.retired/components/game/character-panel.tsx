...
import { CharacterSkeleton } from "./panel-skeletons"
import {
  Swords,
  Shield, 
  Sparkles, 
            ...
            <div className="space-y-2">
              ...
              {oghams.filter(o => o.slotted).length === 0 && (
                <div className="text-center py-4">
                  <Droplets className="w-8 h-8 text-primary/30 mx-auto mb-2 animate-pulse-slow" />
                  <p className="text-sm text-muted-foreground">No Oghams equipped</p>
                  <p className="text-[10px] text-muted-foreground/60 mt-0.5">Find Blood Oghams to power your soul</p>
                </div>
              )}
            </div>
          </CardContent>
