...
export function CharacterAppearanceCreator({ raceName, onComplete, onBack }: {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Preview + Options — stacks vertically on mobile, side-by-side on desktop */}
      <div className="flex flex-col md:grid md:grid-cols-[1fr,auto] gap-4">
        {/* Preview */}
        <div className="flex flex-col items-center">
          <div className="w-36 h-48 md:w-48 md:h-64 bg-secondary/30 rounded-lg border border-border flex items-center justify-center overflow-hidden">
