...
export function CharacterSelect() {
  ...
  return (
    <div className="min-h-[100dvh] bg-background flex items-start md:items-center justify-center p-3 md:p-4 relative overflow-y-auto">
      ...
      <div className="relative z-10 w-full max-w-2xl my-4">
        ...
        {view === 'abilities' && (
          <Card className="celtic-border w-full">
