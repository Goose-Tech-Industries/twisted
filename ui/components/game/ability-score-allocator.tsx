    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {sorted.map(ability => {
          ...
          return (
            <div key={ability.key_name} className="bg-secondary/20 rounded-lg border border-border p-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    <span className="text-sm font-bold">{ability.name}</span>
                    {ability.celtic_name && (
                      <span className="text-[10px] text-primary/60 italic">{ability.celtic_name}</span>
                    )}
                ...
                {/* Modifier */}
                <div className={cn("w-10 h-10 rounded-lg flex items-center justify-center font-bold font-mono text-sm",
