...
export function AudioProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Load settings — defaults are used every session.
    // TEACHING: Audio prefs are cosmetic and non-critical. Defaults are fine.
    // Real persistence would come from the server (state_json) not localStorage.
  ...
  // Settings persist in React state for the session — no localStorage
