...
export function ThemeProvider({ children }: { children: ReactNode }) {
  const [theme, setThemeState] = useState<Theme>(BLOOD_VOID)
  
  // Theme defaults to BLOOD_VOID each session — no localStorage.
  // TEACHING: Theme preference is cosmetic. Server-side persistence
  // can be added later via state_json or a user_prefs table.
