...
const OBJECT_PRESETS = {
    ...
    // ── PROPS (blocking) ─────────────────────────────────────────
    BARREL:     {
        icon: '🪣', label: 'Barrel', type: 'PROP', blocking: true, light: null,
        hint: 'Solid barrel. Blocks movement.'
    },
    OIL_BARREL: {
        icon: '🛢️', label: 'Oil Barrel', type: 'PROP', blocking: true, light: null,
        hint: 'Heavy oil drum. Blocks movement. Add a battle event nearby for explosions.'
    },
    CRATE:      {
    ...
    SIGN:       {
        ...
        hint: 'A sign. Walkthrough — add a DIALOGUE event on same tile.'
    },
    BED:        {
